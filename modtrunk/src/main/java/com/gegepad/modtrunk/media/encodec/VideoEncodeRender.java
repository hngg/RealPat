...
import com.gegepad.modtrunk.media.render.IRender;

import java.nio.ByteBuffer;
import java.nio.ByteOrder;
import java.nio.FloatBuffer;

public class VideoEncodeRender implements IRender {
    private static final String TAG = VideoEncodeRender.class.getName();
    ...
    public VideoEncodeRender(Context context,int textureId, ITextureFrame tex) {
...
//        GLES20.glVertexAttribPointer(afPosition, COORDS_PER_VERTEX, GLES20.GL_FLOAT, false, vertexStride, textureBuffer);
        ...
        Log.d(TAG, "onDrawFrame getEncoder.");
        //getEncoder(false);
        //frameAvailable();
        mTexCodec.onframeAvailable();
