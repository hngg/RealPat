...
import com.gegepad.modtrunk.R;
import com.gegepad.modtrunk.media.util.DisplayUtil;
import com.gegepad.modtrunk.media.util.ShaderUtil;

import java.nio.ByteBuffer;
import java.nio.ByteOrder;
import java.nio.FloatBuffer;

public class EglFboRender implements IRender, SurfaceTexture.OnFrameAvailableListener {
    private static final String TAG = EglFboRender.class.getName();
    //顶点坐标
    ...
    public void onFrameAvailable(SurfaceTexture surfaceTexture) {
        if(onSurfaceListener!=null)
            onSurfaceListener.onFrameComing(surfaceTexture);
        Log.e(TAG, "onDrawFrame FrameAvailable");
    }
    ...
    public interface OnSurfaceListener {
        ...
        void onFrameComing(SurfaceTexture surfaceTexture);
    }
