...
package com.gegepad.SurfaceVideo.camera;
...
public class ThumbnailController {
    ...
    public ThumbnailController(Resources resources, ContentResolver contentResolver) {
        mResources = resources;
        mContentResolver = contentResolver;
    }

    public Drawable getThumbnailDrawble(String filePath, int miniThumbWidth, int miniThumbHeight) {
        ...
        try {
            ...
            mThumb = ThumbnailUtils.extractThumbnail(
                    thumb, miniThumbWidth, miniThumbHeight);
            Drawable drawable;
            if (mThumbs == null)
            {
    ...
    public Drawable updateThumbnail(Uri uri, Bitmap original, int miniThumbWidth, int miniThumbHeight)
    {
    ...
    public boolean isUriValid() {
        ...
        try {
            ParcelFileDescriptor pfd = mContentResolver.openFileDescriptor(mUri, "r");
            if (pfd == null) {
